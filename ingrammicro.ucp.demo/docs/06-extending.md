...
```
User: "I want to return the server racks I ordered"
→ Agent: get_recent_orders() - finds order with server racks
→ Agent: "Found server racks in order #ORD-12345. Why the return?"
