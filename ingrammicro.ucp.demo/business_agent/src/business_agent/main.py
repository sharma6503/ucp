...
async def run(host, port):
    ...
    """
    if not os.getenv("GOOGLE_CLOUD_PROJECT") or not os.getenv("GOOGLE_API_KEY") or not os.getenv("GOOGLE_CLOUD_LOCATION"):
        logger.error("GOOGLE_CLOUD_PROJECT, GOOGLE_API_KEY and GOOGLE_CLOUD_LOCATION must be set")
        exit(1)
